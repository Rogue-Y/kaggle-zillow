...
from .config_linear import config_linear_huber, config_linearlasso, config_linearridge,\
    config_linearridge2, config_linearRANSAC, config_linearRANSAC2
...
from .config_catboost import config_catboost
