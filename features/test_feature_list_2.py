...
feature_list = {
    ...
    'generated': [
        ...
        ('category_architecture_style_one_hot', category_architecture_style_one_hot, {}, 'category_architecture_style_one_hot', False),
        ('category_building_class_one_hot', category_building_class_one_hot, {}, 'category_building_class_one_hot', False),
        ...
        # ('target_neighborhood_feature', target_region_feature, {'id_name':'regionidneighborhood'}, 'target_neighborhood_feature_pickle', True),
        # ('target_zip_feature', target_region_feature, {'id_name':'regionidzip'}, 'target_zip_feature_pickle', True),
        # ('target_city_feature', target_region_feature, {'id_name':'regionidcity'}, 'target_city_feature_pickle', True),
        # ('target_county_feature', target_region_feature, {'id_name':'regionidcounty'}, 'target_county_feature_pickle', True),
    ]
}
